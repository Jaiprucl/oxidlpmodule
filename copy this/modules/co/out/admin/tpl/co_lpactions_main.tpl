...
<form name="transfer" id="transfer" action="[{ $oViewConf->getSelfLink() }]" method="post">
    ...
    <input type="hidden" name="cl" value="co_lpactions_main">
</form>
        ...
        [{block name="admin_actions_main_form"}]
            <tr>
			 ...
			 <tr>
                ...
                <td class="edittext">
                <input type="hidden" class="editinput" size="32" name="editval[oxactions__oxid]" value="[{$edit->oxactions__oxid->value}]" [{ $readonly }] [{ $disableSharedEdit }]>
                </td>
            </tr>
			...
			<tr>
                <td class="edittext">[{ oxmultilang ident="GENERAL_LANDINGPAGE_TEXT" }]
                </td>
              <td class="edittext">
                <textarea name="editval[oxcontents__oxcontent]" rows="8" cols="150">[{$oView->getSeoText()}]</Textarea>
              </td>
            </tr>
            <tr>
                <td class="edittext">
              ...
              <td class="edittext">
                <select class="editinput" name="editval[oxactions__oxtype]">
                  <option value="4">[{ oxmultilang ident="GENERAL_LANDINGPAGE" }]</option>
                </select>
              </td>
            </tr>
         [{/block}]
